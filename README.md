# Desafio 02 - Dio Campus Expert Turma 15
## Escalando oportunidades com o seu portifólio de projetos
            ...
            <div class="tab-pane fade show active" id="portuguese" role="tabpanel" aria-labelledby="portuguese-tab">
                ...
                <section id="experiencia">
                    <div class="container">
                      ...
                      <div class="row">
                            <div class="col-sm-4">
                                <p class="font-weight-bold">Atacadão</p>
                            </div>
                            <div class="col-sm-5">
                                <p class="lead font-weight-bold">Auxiliar de Informática</p>
                                <p>Atividades: Suporte técnico, manutenção de computadores e atendimento ao usuário. Conhecimento em redes básicas, sistemas operacionais e instalação de softwares. </p>
                            </div>
                            <div class="col-sm-3">
                                <p class="lead">Agosto 2025 atual</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4">
